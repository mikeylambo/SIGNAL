...
window.addEventListener('load', () => {
  ...
  // Measure menu sheet height and set CSS variable so controls-hint sits just above it.
  // Re-measure on resize since the sheet height can change on font scale / orientation change.
